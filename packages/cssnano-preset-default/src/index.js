...
const postcssMinifySelectors = require('@pumpn/postcss-minify-selectors');
...
const postcssMergeLonghand = require('@pumpn/postcss-merge-longhand');
...
const postcssMergeRules = require('@pumpn/postcss-merge-rules');
const postcssDiscardEmpty = require('postcss-discard-empty');
const postcssUniqueSelectors = require('@pumpn/postcss-unique-selectors');
